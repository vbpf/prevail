...
// Generated by scripts/generate_verify_project_tests.py for project 'bpf_cilium_test'.
...
TEST_SECTION_REJECT("bpf_cilium_test", "bpf_lb-DLB_L3.o", "from-netdev")
TEST_SECTION("bpf_cilium_test", "bpf_lb-DLB_L4.o", "2/1")
TEST_SECTION("bpf_cilium_test", "bpf_lb-DLB_L4.o", "2/2")
// Intentional stricter memory-initialization policy: this sample reads or passes stack bytes that are not proven
// initialized; helper output success or stack padding is not treated as initialized by default.
TEST_SECTION_REJECT("bpf_cilium_test", "bpf_lb-DLB_L4.o", "from-netdev")
...
// Intentional stricter memory-initialization policy: this sample reads or passes stack bytes that are not proven
// initialized; helper output success or stack padding is not treated as initialized by default.
TEST_SECTION_REJECT("bpf_cilium_test", "bpf_lxc-DDROP_ALL.o", "1/0x1010")
...
// Intentional stricter memory-initialization policy: this sample reads or passes stack bytes that are not proven
// initialized; helper output success or stack padding is not treated as initialized by default.
TEST_SECTION_REJECT("bpf_cilium_test", "bpf_lxc-DDROP_ALL.o", "2/7")
TEST_SECTION("bpf_cilium_test", "bpf_lxc-DDROP_ALL.o", "from-container")
// Intentional stricter memory-initialization policy: this sample reads or passes stack bytes that are not proven
// initialized; helper output success or stack padding is not treated as initialized by default.
TEST_SECTION_REJECT("bpf_cilium_test", "bpf_lxc-DUNKNOWN.o", "1/0x1010")
...
// Intentional stricter memory-initialization policy: this sample reads or passes stack bytes that are not proven
// initialized; helper output success or stack padding is not treated as initialized by default.
TEST_SECTION_REJECT("bpf_cilium_test", "bpf_lxc-DUNKNOWN.o", "2/7")
// Intentional stricter memory-initialization policy: this sample reads or passes stack bytes that are not proven
// initialized; helper output success or stack padding is not treated as initialized by default.
TEST_SECTION_REJECT("bpf_cilium_test", "bpf_lxc-DUNKNOWN.o", "from-container")
// Intentional stricter memory-initialization policy: this sample reads or passes stack bytes that are not proven
// initialized; helper output success or stack padding is not treated as initialized by default.
TEST_SECTION_REJECT("bpf_cilium_test", "bpf_lxc_jit.o", "1/0xdc06")
TEST_SECTION("bpf_cilium_test", "bpf_lxc_jit.o", "2/1")
// Intentional stricter memory-initialization policy: this sample reads or passes stack bytes that are not proven
// initialized; helper output success or stack padding is not treated as initialized by default.
TEST_SECTION_REJECT("bpf_cilium_test", "bpf_lxc_jit.o", "2/10")
...
// Intentional stricter memory-initialization policy: this sample reads or passes stack bytes that are not proven
// initialized; helper output success or stack padding is not treated as initialized by default.
TEST_SECTION_REJECT("bpf_cilium_test", "bpf_lxc_jit.o", "2/7")
...
TEST_SECTION("bpf_cilium_test", "bpf_netdev.o", "3/2")
