...
//   diagnostic: Subprogram not found: ebpf_map_update_elem
TEST_SECTION_LOAD_FAIL("build", "badrelo.o", ".text", verify_test::VerifyIssueKind::ElfSubprogramResolution,
...
TEST_SECTION_LOAD_FAIL("build", "externalfunction.o", ".text", verify_test::VerifyIssueKind::ElfSubprogramResolution,
                       "Known loader limitation: subprogram resolution/disambiguation is incomplete for this object. "
                       "Diagnostic: Subprogram not found: bpf_map_lookup_elem")
