...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 3: Invalid type (r0.type == number)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 27: Upper bound must be at most packet_size (valid_access(r1.offset+12, width=1) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 18: Upper bound must be at most packet_size (valid_access(r1.offset+12, width=1) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 21: Upper bound must be at most packet_size (valid_access(r1.offset+12, width=1) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 29: Upper bound must be at most packet_size (valid_access(r1.offset+12, width=1) for read)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 328: Invalid type (r4.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 299: Invalid type (r3.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 203: Invalid type (r3.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 134: Invalid type (r7.type == number)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 46: Invalid type (r2.type == number)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 42: Invalid type (r2.type == number)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 669: Invalid type (r2.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierNullability): Known verifier limitation: nullability tracking is too conservative on this path. Diagnostic: 927: Non-null number ((r2.type == number and r2.value == 0) or valid_access(r2.offset, width=r3) for read)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 840: Invalid type (r3.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 296: Invalid type (r9.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierStackInitialization): Known verifier limitation: stack initialization tracking is too coarse for this access path. Diagnostic: 1026: Stack content is not numeric (valid_access(r2.offset+32, width=4) for read)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 689: Invalid type (r3.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 1239: Invalid type (r8.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 70: Upper bound must be at most packet_size (valid_access(r1.offset+12, width=1) for read)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 495: Invalid type (r3.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 29: Invalid type (r2.type == number)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 444: Invalid type (valid_access(r3.offset) for comparison/subtraction)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 464: Invalid type (r3.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 521: Invalid type (r1.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 51: Invalid type (r2.type == number)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 625: Invalid type (r3.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierStackInitialization): Known verifier limitation: stack initialization tracking is too coarse for this access path. Diagnostic: 1011: Stack content is not numeric (valid_access(r2.offset+32, width=4) for read)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 670: Invalid type (r4.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 1175: Invalid type (r7.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 9: Invalid type (valid_access(r3.offset) for comparison/subtraction)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 228: Upper bound must be at most 144 (valid_access(r4.offset+160, width=4) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 2122: Upper bound must be at most 144 (valid_access(r6.offset+160, width=4) for read)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 32: Invalid type (r4.type == number)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 1618: Invalid type (r0.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 2349: Invalid type (r5.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 40: Invalid type (r2.type == func)
...
// expected failure (VerifierStackInitialization): Known verifier limitation: stack initialization tracking is too coarse for this access path. Diagnostic: 1010: Stack content is not numeric (valid_access(r2.offset+32, width=4) for read)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 668: Invalid type (r4.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 1172: Invalid type (r7.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierMapTyping): Known verifier limitation: map value/key typing and scalarization are too conservative here. Diagnostic: 303: Illegal map update with a non-numerical value [4048-4072) (within(r2:key_size(r1)))
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 8: Upper bound must be at most 48 (valid_access(r6.offset+52, width=4) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 2096: Upper bound must be at most 144 (valid_access(r6.offset+160, width=4) for read)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 32: Invalid type (r5.type == number)
...
// expected failure (VerifierStackInitialization): Known verifier limitation: stack initialization tracking is too coarse for this access path. Diagnostic: 1009: Stack content is not numeric (valid_access(r2.offset+32, width=4) for read)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 668: Invalid type (r9.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. Diagnostic: 1143: Invalid type (r9.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 51: Upper bound must be at most packet_size (valid_access(r5.offset, width=1) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 170: Upper bound must be at most packet_size (valid_access(r4.offset, width=4) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 66: Upper bound must be at most packet_size (valid_access(r3.offset, width=2) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 283: Upper bound must be at most packet_size (valid_access(r0.offset, width=2) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 76: Upper bound must be at most packet_size (valid_access(r3.offset, width=2) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 97: Upper bound must be at most packet_size (valid_access(r4.offset, width=4) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 74: Upper bound must be at most packet_size (valid_access(r4.offset, width=2) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 82: Upper bound must be at most packet_size (valid_access(r4.offset, width=4) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 47: Upper bound must be at most packet_size (valid_access(r4.offset, width=2) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 60: Upper bound must be at most packet_size (valid_access(r4.offset, width=2) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for this memory-access proof. Diagnostic: 139: Upper bound must be at most packet_size (valid_access(r4.offset, width=4) for read)
