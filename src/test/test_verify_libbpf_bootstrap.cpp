...
// this memory-access proof. Diagnostic: 24: Lower bound must be at least 0 (valid_access(r7.offset) for
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for
// this memory-access proof. Diagnostic: 39: Lower bound must be at least 0 (valid_access(r6.offset) for
// comparison/subtraction)
...
// control-flow pattern. Diagnostic: 70: Invalid type (r3.type == number)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for
// this memory-access proof. Diagnostic: 0: Upper bound must be at most 0 (valid_access(r1.offset+16, width=8) for read)
...
TEST_SECTION_SKIP("libbpf-bootstrap", "ksyscall.bpf.o", "ksyscall/kill",
...
// skipped (ExternalSymbolResolution): Known architectural limitation: unresolved external symbols are not modeled in
// offline verification. Diagnostic: Unresolved symbols found.
TEST_SECTION_SKIP("libbpf-bootstrap", "ksyscall.bpf.o", "ksyscall/tgkill",
                  verify_test::VerifyIssueKind::ExternalSymbolResolution,
                  "Known architectural limitation: unresolved external symbols are not modeled in offline "
                  "verification. Diagnostic: Unresolved symbols found.")
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for
// this memory-access proof. Diagnostic: 0: Upper bound must be at most 0 (valid_access(r1.offset+24, width=8) for read)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for
// this memory-access proof. Diagnostic: 12: Lower bound must be at least 0 (valid_access(r7.offset) for
// comparison/subtraction)
...
// expected failure (VerifierBoundsTracking): Known verifier limitation: interval/bounds refinement loses precision for
// this memory-access proof. Diagnostic: 27: Lower bound must be at least 0 (valid_access(r7.offset) for
// comparison/subtraction)
...
// skipped (ExternalSymbolResolution): Known architectural limitation: unresolved external symbols are not modeled in
// offline verification. Diagnostic: Unresolved symbols found.
TEST_PROGRAM_SKIP("libbpf-bootstrap", "usdt.bpf.o", ".text", "bpf_usdt_arg",
                  verify_test::VerifyIssueKind::ExternalSymbolResolution,
                  "Known architectural limitation: unresolved external symbols are not modeled in offline "
                  "verification. Diagnostic: Unresolved symbols found.")
// skipped (ExternalSymbolResolution): Known architectural limitation: unresolved external symbols are not modeled in
// offline verification. Diagnostic: Unresolved symbols found.
TEST_PROGRAM_SKIP("libbpf-bootstrap", "usdt.bpf.o", ".text", "bpf_usdt_arg_cnt",
                  verify_test::VerifyIssueKind::ExternalSymbolResolution,
                  "Known architectural limitation: unresolved external symbols are not modeled in offline "
                  "verification. Diagnostic: Unresolved symbols found.")
// skipped (ExternalSymbolResolution): Known architectural limitation: unresolved external symbols are not modeled in
// offline verification. Diagnostic: Unresolved symbols found.
TEST_PROGRAM_SKIP("libbpf-bootstrap", "usdt.bpf.o", ".text", "bpf_usdt_cookie",
                  verify_test::VerifyIssueKind::ExternalSymbolResolution,
                  "Known architectural limitation: unresolved external symbols are not modeled in offline "
                  "verification. Diagnostic: Unresolved symbols found.")
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this
// control-flow pattern. Diagnostic: 4/33: Invalid type (r1.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this
// control-flow pattern. Diagnostic: 4/40: Invalid type (r1.type in {ctx, stack, packet, shared})
