...
// control-flow pattern. Diagnostic: 2: Invalid type (valid_access(r7.offset) for comparison/subtraction)
...
TEST_SECTION_SKIP("bcc", "capable.bpf.o", "kretprobe/cap_capable",
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this
// control-flow pattern. Diagnostic: 17: Invalid type (r6.type in {number, ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this
// control-flow pattern. Diagnostic: 34: Invalid type (r6.type in {number, ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this
// control-flow pattern. Diagnostic: 35: Invalid type (r6.type in {number, ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this
// control-flow pattern. Diagnostic: 38: Invalid type (r7.type in {ctx, stack, packet, shared})
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this
// control-flow pattern. Diagnostic: 21: Invalid type (r7.type in {ctx, stack, packet, shared})
...
// this memory-access proof. Diagnostic: 57: Upper bound must be at most r1.shared_region_size (valid_access(r1.offset,
// width=4) for read)
TEST_SECTION_FAIL(
