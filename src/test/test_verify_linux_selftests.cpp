...
// this object. Diagnostic: Subprogram not found: tcp_reno_cong_avoid
...
// control-flow shape. Diagnostic: unmarshaling error at 15: jump out of bounds
TEST_PROGRAM_FAIL("linux-selftests", "map_ptr_kern.o", ".text", "check_array_of_maps", 19,
                  ...
                  "Diagnostic: unmarshaling error at 15: jump out of bounds")
// expected failure (UnmarshalControlFlow): Known loader limitation: instruction unmarshaling cannot reconstruct this
// control-flow shape. Diagnostic: unmarshaling error at 13: jump out of bounds
TEST_PROGRAM_FAIL("linux-selftests", "map_ptr_kern.o", ".text", "check_cgroup_storage", 19,
                  verify_test::VerifyIssueKind::UnmarshalControlFlow,
                  "Known loader limitation: instruction unmarshaling cannot reconstruct this control-flow shape. "
                  "Diagnostic: unmarshaling error at 13: jump out of bounds")
// expected failure (UnmarshalControlFlow): Known loader limitation: instruction unmarshaling cannot reconstruct this
// control-flow shape. Diagnostic: unmarshaling error at 13: jump out of bounds
TEST_PROGRAM_FAIL("linux-selftests", "map_ptr_kern.o", ".text", "check_cpumap", 19,
                  ...
                  "Diagnostic: unmarshaling error at 13: jump out of bounds")
// expected failure (UnmarshalControlFlow): Known loader limitation: instruction unmarshaling cannot reconstruct this
// control-flow shape. Diagnostic: unmarshaling error at 9: jump out of bounds
TEST_PROGRAM_FAIL("linux-selftests", "map_ptr_kern.o", ".text", "check_default_noinline", 19,
                  verify_test::VerifyIssueKind::UnmarshalControlFlow,
                  "Known loader limitation: instruction unmarshaling cannot reconstruct this control-flow shape. "
                  "Diagnostic: unmarshaling error at 9: jump out of bounds")
// expected failure (UnmarshalControlFlow): Known loader limitation: instruction unmarshaling cannot reconstruct this
// control-flow shape. Diagnostic: unmarshaling error at 13: jump out of bounds
...
TEST_PROGRAM_FAIL("linux-selftests", "map_ptr_kern.o", ".text", "check_xskmap", 19,
                  ...
                  "Diagnostic: unmarshaling error at 13: jump out of bounds")
// skipped (ElfSubprogramResolution): Known loader limitation: subprogram resolution/disambiguation is incomplete for
// this object. Diagnostic: Subprogram not found: bpf_map_sum_elem_count
TEST_SECTION_SKIP("linux-selftests", "map_ptr_kern.o", "cgroup_skb/egress",
                  verify_test::VerifyIssueKind::ElfSubprogramResolution,
                  "Known loader limitation: subprogram resolution/disambiguation is incomplete for this object. "
...
// expected failure (UnmarshalControlFlow): Known loader limitation: instruction unmarshaling cannot reconstruct this
// control-flow shape. Diagnostic: unmarshaling error at 39: jump out of bounds
TEST_PROGRAM_FAIL("linux-selftests", "test_global_func1.o", ".text", "f1", 4,
                  verify_test::VerifyIssueKind::UnmarshalControlFlow,
                  "Known loader limitation: instruction unmarshaling cannot reconstruct this control-flow shape. "
                  "Diagnostic: unmarshaling error at 39: jump out of bounds")
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this
// control-flow pattern. Diagnostic: 1: Invalid type (r1.type == number)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this
// control-flow pattern. Diagnostic: 1/57/63: Invalid type (r1.type == number)
TEST_SECTION_FAIL("linux-selftests", "test_global_func1.o", "tc", verify_test::VerifyIssueKind::VerifierTypeTracking,
                  "Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. "
                  "Diagnostic: 1/57/63: Invalid type (r1.type == number)")
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this
...
// expected failure (UnmarshalControlFlow): Known loader limitation: instruction unmarshaling cannot reconstruct this
// control-flow shape. Diagnostic: unmarshaling error at 0: jump out of bounds
TEST_PROGRAM_FAIL("linux-selftests", "test_spin_lock.o", "tc", "lock_static_subprog_lock", 3,
                  verify_test::VerifyIssueKind::UnmarshalControlFlow,
                  "Known loader limitation: instruction unmarshaling cannot reconstruct this control-flow shape. "
                  "Diagnostic: unmarshaling error at 0: jump out of bounds")
// expected failure (UnmarshalControlFlow): Known loader limitation: instruction unmarshaling cannot reconstruct this
