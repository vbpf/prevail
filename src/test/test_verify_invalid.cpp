...
// skipped (ElfCoreRelocation): Known loader limitation: CO-RE/BTF relocation payload is unsupported or malformed for
// this object. Diagnostic: Unsupported or invalid CO-RE/BTF relocation data: Invalid .BTF section - invalid BTF_KIND -
// 0
TEST_SECTION_SKIP(
...
// this memory-access proof. Diagnostic: 12: Upper bound must be at most 20 (valid_access(r6.offset+24, width=4) for
// read)
...
// control-flow pattern. Diagnostic: 13: Invalid type (r1.type == map_fd)
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this
// control-flow pattern. Diagnostic: 60: Invalid type (r2.type in {ctx, stack, packet, shared})
...
// control-flow shape. Diagnostic: unmarshaling error at 1: incomplete lddw
...
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this
// control-flow pattern. Diagnostic: 20: Invalid type (r1.type == ctx)
TEST_SECTION_FAIL("invalid", "timeout-29db93548c671165313b314d4f83a3eefa24df37", "bind",
                  verify_test::VerifyIssueKind::VerifierTypeTracking,
                  "Known verifier limitation: register type refinement is too imprecise in this control-flow pattern. "
                  "Diagnostic: 20: Invalid type (r1.type == ctx)")
// expected failure (VerifierTypeTracking): Known verifier limitation: register type refinement is too imprecise in this
// control-flow pattern. Diagnostic: 48: Invalid type (r1.type == ctx)
